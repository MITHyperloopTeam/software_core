...
static void mithl_analog_front_low_rate_t_handler_up(const zcm_recv_buf_t *rbuf, const char *channel,
                       const mithl_analog_front_low_rate_t *msg, void *user)
{
  mithl_analog_front_low_rate_t_publish(zcm_udp, channel, msg);
}
static void mithl_analog_front_medium_rate_t_handler_up(const zcm_recv_buf_t *rbuf, const char *channel,
                       const mithl_analog_front_medium_rate_t *msg, void *user)
{
  mithl_analog_front_medium_rate_t_publish(zcm_udp, channel, msg);
}
static void mithl_analog_front_high_rate_t_handler_up(const zcm_recv_buf_t *rbuf, const char *channel,
                       const mithl_analog_front_high_rate_t *msg, void *user)
{
  mithl_analog_front_high_rate_t_publish(zcm_udp, channel, msg);
}
      ...
      char** argv  )
{
  ...
  mithl_analog_front_low_rate_t_subscribe(zcm_serial, "_AF_OL", &mithl_analog_front_low_rate_t_handler_up, NULL);
  mithl_analog_front_medium_rate_t_subscribe(zcm_serial, "_AF_OM", &mithl_analog_front_medium_rate_t_handler_up, NULL);
  mithl_analog_front_high_rate_t_subscribe(zcm_serial, "_AF_OH", &mithl_analog_front_high_rate_t_handler_up, NULL);
  
  mithl_battery_status_t_subscribe(zcm_serial, "_AF_BATTERY", &battery_status_handler, NULL);
  mithl_string_t_subscribe(zcm_serial, "_AF_DEBUG", &string_handler, NULL);
