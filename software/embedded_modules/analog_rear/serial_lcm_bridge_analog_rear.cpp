...
static void mithl_analog_rear_low_rate_t_handler_up(const zcm_recv_buf_t *rbuf, const char *channel,
                       const mithl_analog_rear_low_rate_t *msg, void *user)
{
  mithl_analog_rear_low_rate_t_publish(zcm_udp, channel, msg);
}
static void mithl_analog_rear_medium_rate_t_handler_up(const zcm_recv_buf_t *rbuf, const char *channel,
                       const mithl_analog_rear_medium_rate_t *msg, void *user)
{
  mithl_analog_rear_medium_rate_t_publish(zcm_udp, channel, msg);
}
static void mithl_analog_rear_high_rate_t_handler_up(const zcm_recv_buf_t *rbuf, const char *channel,
                       const mithl_analog_rear_high_rate_t *msg, void *user)
{
  mithl_analog_rear_high_rate_t_publish(zcm_udp, channel, msg);
}
      ...
      char** argv  )
{
  ...
  if (argc == 2)
    ...
    serial_port = "/dev/mithl_analog_rear";
  ...
  mithl_analog_rear_low_rate_t_subscribe(zcm_serial, "_AR_OL", &mithl_analog_rear_low_rate_t_handler_up, NULL);
  mithl_analog_rear_medium_rate_t_subscribe(zcm_serial, "_AR_OM", &mithl_analog_rear_medium_rate_t_handler_up, NULL);
  mithl_analog_rear_high_rate_t_subscribe(zcm_serial, "_AR_OH", &mithl_analog_rear_high_rate_t_handler_up, NULL);
